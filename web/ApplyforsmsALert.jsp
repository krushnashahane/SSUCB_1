    ...
    <body>
        ...
        <div class="module form-module">
            ...
            <div class="form">
                ...
                <div class="x_content">
                    <form name="frm" action="AddSmSAlert.jsp" method="post" class="form-horizontal form-label-left" novalidate>
                        ...
                        <div class="item form-group">
                         ...
                         <div class="item form-group">
                            <input type="text" name="city"  class="form-control col-md-7 col-xs-12"  placeholder="City" required="required"/>
                        </div>
                          <div class="item form-group">
                            <input type="text" name="contact"  class="form-control col-md-7 col-xs-12"  placeholder="SMS Alert Mobile Number" required="required"/>
                        </div>
                        
                          <div class="item form-group">
                              <label>DOB</label>
                            <input type="date" name="dob"  class="form-control col-md-7 col-xs-12"  placeholder="DOB" required="required"/>
                         </div>
               
                        <div class="item form-group">
                            <input type="text" name="bankac"  class="form-control col-md-7 col-xs-12"  placeholder="Bank Account Number" required="required"/>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="form-group">
                                <lable>Mode of Operation</lable>
                                <select name="modeofoperation">
                           ...
                           <div class="item form-group">
                            ...
                            <input type="date" name="date"  class="form-control col-md-7 col-xs-12"    required="required"/>
                              ...
                              <div class="item form-group">
                            <input type="text" name="place" class="form-control col-md-7 col-xs-12"  placeholder="Place" required="required"/>
                        </div>
                            </div>
