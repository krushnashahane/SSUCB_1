...
#tableData {
  ...
  font-family: Arial, sans-serif;
   ...
   <div class="jquery-script-center">
             ...
             <nav id="menu">
                                ...
                                <div id="navbar-collapse-1" class="navbar-collapse collapse">
                                    ...
                                    <ul class="nav navbar-nav">
										...
										<!-- About Us -->
										 <li class="dropdown">
										  ...
										  <ul class="dropdown-menu">
                                                     ...
                                                     <li><a href="Honorable-Founder.html"><b> Honorable Founder </b></a></li>
                                                      <li><a href="chairman_desk.html"><b> Chairman Desk </b></a></li>
													  <li><a href="BoardOfDirector.html"><b> Board of Directors </b> </a></li>
													  <li><a href="finantialPosition.html"><b> Financial Position </b> </a></li>
                                          </ul>
                                        ...
                                        <li class="dropdown">
										  ...
										  <ul class="dropdown-menu">
													<li><a href="rtgs.html"> RTGS/NEFT</a></li>
													<li><a href="ecs.html"> ECS </a></li>
													<li><a href="locker.html"> Lockers </a></li>
													<li><a href="AadharEnabled.html"> Adhar Enabled</a></li>
													<li><a href="generalInsurance.html"> General Insurance</a></li>
													<li><a href="internetBanking.html"> Internet Banking</a></li>
													<li><a href="smsAlert.html"> SMS Alert </a></li>
													<li><a href="MPOS.html"> POS</a></li>
													<li><a href="cashDeposit.html"> Cash Deposit Machines</a></li>
                                          </ul>
                                        ...
                                        <!-- Portfolio Nav Item -->
                                        <li class="dropdown">
                                          <a href="customer-desk.html">
                                            Customer's Desk <!--  <b class="caret"> </b> -->
                                          </a>
                                          <ul class="dropdown-menu">
                                            <li>
                ...
                <div class="content_info-">
                    ...
                    <div class="section-title-01">
                        <div class="container-fluid" style="background-image:url('img/icon2/banner.jpg')">
                            <div class="row">
                                <div class="col-md-12">
    ...
    <h3 style="color:#b80108;margin-left:5px;margin-bottom:11%;" >More links</h3>

 <!-- sidebar accordian -->

  <div class="panel-group" id="accordionMenu" role="tablist" aria-multiselectable="true" style=" box-shadow: 2px 2px 2px 2px #888888;margin-left:5px;">
      ...
      <div id="collapseOne" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne">
        <div class="panel-body">
          <ul class="nav">
            ...
            <li><a href="InterestRates.html">Deposit Interest </a></li>
            <li><a href="LoanInterestRates.html">Loan Interest </a></li>
			 <li><a href="ServiceCharges.html">Service Charges </a></li>
          </ul>
        </div>
      </div>
    </div>
 ...
 <!--   <div class="panel panel-default">
	 ...
	 <div class="panel panel-default">
      <div class="panel-heading" role="tab" id="headingFive">
        <h4 class="panel-title">
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionMenu" href="#collapseFive" aria-expanded="false" aria-controls="collapseTwo">
         Service Charges
        </a>
      </h4>
      </div>
	 ...
	 <div class="panel panel-default">
      <div class="panel-heading" role="tab" id="headingTwo">
        <h4 class="panel-title">
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionMenu" href="#collapseSix" aria-expanded="false" aria-controls="collapseTwo">
          Downloads
        </a>
      </h4>
      </div>
	 ...
	 <div class="panel panel-default">
      <div class="panel-heading" role="tab" id="headingTwo">
        <h4 class="panel-title">
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionMenu" href="#collapseSeven" aria-expanded="false" aria-controls="collapseTwo">
          Customer Support
        </a>
      </h4>
      </div>
      <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
        <div class="panel-body">
          <ul class="nav">
            <li><a href="customer-desk.html">Customer Support</a></li>
      ...
      <div class="panel-heading" role="tab" id="headingTwo">
        <h4 class="panel-title">
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionMenu" href="#collapseEight" aria-expanded="false" aria-controls="collapseTwo">
          News & Events
        </a>
      </h4>
      </div>
      ...
      <div class="panel-heading" role="tab" id="headingTwo">
        <h4 class="panel-title">
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionMenu" href="#collapseNine" aria-expanded="false" aria-controls="collapseTwo">
         Careers
        </a>
      </h4>
      </div>
	 ...
	 <div class="panel panel-default">
      <div class="panel-heading" role="tab" id="headingTwo">
        <h4 class="panel-title">
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionMenu" href="#collapseTen" aria-expanded="false" aria-controls="collapseTwo">
         Tenders
        </a>
      </h4>
      </div>
      <div id="collapseTen" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
        <div class="panel-body">
          <ul class="nav">
            ...
            <li><a href="AuctionNotice.html">Auction Notice</a></li>
            <li><a href="Tender.jsp">View Tenders</a></li>
          </ul>
        </div>
      </div>
    </div>
	...
	<img src="img/icon2/logo.jpg" alt="" class="img-responsive"> <br>
  </div>	
