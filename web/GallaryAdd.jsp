    ...
    <body>
        ...
        <div class='content isOpen'>
            ...
            <div class="tab">
                ...
                <button class="tablinks" onclick="openCity(event, 'addmanager')">Gallery Detail</button>
                <button class="tablinks" onclick="openCity(event, 'view')">View Gallery</button>
            ...
            <div id="addmanager" class="tabcontent">
                ...
                <form name="frm" action="AddGalary.jsp" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
            ...
            <div id="view" class="tabcontent">
                ...
                <%
                    try {
                        java.sql.ResultSet rs = GalaryDao.getAllgallary();
                %>
