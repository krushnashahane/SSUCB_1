...
<html>
    <head>
        ...
        <div class='content isOpen'>
            ...
            <div class="tab">
                <button class="tablinks" onclick="openCity(event, 'addbranch')">Add New Loan Interest Type</button>
                <button class="tablinks" onclick="openCity(event, 'view')">View Loan Interest Type</button>
                <!-- <button class="tablinks" onclick="openCity(event, 'search')">Search Branches</button>-->
            </div>

            <div id="addbranch" class="tabcontent">
                <h3>Add Loan Interest Type Form</h3>
                <br><br>

                    <form  action="AddLoanInterestType.jsp" class="form-horizontal form-label-left" method="POST" novalidate>
 <div class="item form-group">
                         <input type="text" name="type" id="name" value="" data-validate-length-range="6" data-validate-words="2"  placeholder="Loan Interest Type" required="required"/>
 </div>
                                ...
                                <input type="submit" name="s"  value="Add New Loan Interest Type" class="buttonsubmit button4"/>
            ...
            <div id="view" class="tabcontent">
                ...
                <%
                    try {
                        ...
                        ArrayList<LoanInterestType> al = LoanDao.GetAllLoanInterestType();
                        LoanInterestType d = new LoanInterestType();
                ...
                <table class="tftable" id="tblData3" border="1">
                    ...
                    <tr><th>Loan Interest Type ID</th>
                        <th>Type</th>
