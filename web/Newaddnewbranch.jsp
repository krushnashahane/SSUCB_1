        ...
        <div class='content isOpen'>
            ...
            <div id="addbranch" class="tabcontent">
                ...
                <form  action="" id="register-form"  method="POST" novalidate="novalidate">
                    ...
                    <div class="fieldgroup">
                        <input type="text" name="contact" value="" id="telephone" placeholder="contact" required="required"/>
                    </div>
                    <label>Opening Date</label>
                    <div class="fieldgroup">
                        <input type="date" name="date" placeholder="Select Date" required="required"/></div>


                     <div class="fieldgroup">
                         <input type="text" name="ifsc" value="" id="name" placeholder="Enter IFSC CODE" required="required"/></div>
                    ...
                    <div class="fieldgroup">
                        ...
                        <label>
                                Select District:</label> <div class="fieldgroup"><select required="required" name="district"><option>Parbhani</option>
                     ...
                     <label>Select District:</label> 
                            <div class="fieldgroup"><select name="taluka"><option>Taluka</option>

                                </select></div>
                        
                            <div class="fieldgroup"><input type="text" required="required" name="city" value="" placeholder="Enter City  Name"/>
                            </div>
                        ...
                        <td colspan='2'> 
                            <div class="fieldgroup">
                                <textarea required="required" name='address' id="address" placeholder="Enter Address" ></textarea>
                            </div>

                   
                     <div class="fieldgroup"><input type="text" name="latitude" value="" id="name" placeholder="Enter Latitude"/></div></td>
                        <div class="fieldgroup"><input type="text" name="langitude" value="" id="name" placeholder="Enter Langitude"/></div></td></tr>
                  
                            <div class="fieldgroup">   <input type="submit" name="s"   value="Add New Branch" class="submit"/>
                            </div>
