    ...
    <head>
        ...
        <div class='content isOpen'>
            ...
            <div class="tab">
                ...
                <button class="tablinks" onclick="openCity(event, 'view')">View Contact Us</button>
            ...
            <div id="view" class="tabcontent">
                ...
                <%
                    try {
                        ...
                        ResultSet rs = ContactUsDao.GetAllContactUS();
                ...
                <table class="tftable" id="tblData3" border="1">
                    ...
                    <tr>
                        ...
                        <td align="center"><a href="DeleteContactus.jsp?cid=<%=rs.getInt(1)%>">Delete</a></td>
                        <!-- 
