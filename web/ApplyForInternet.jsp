    ...
    <body>
        ...
        <div class="module form-module">
            ...
            <div class="form">
                ...
                <div class="x_content">
                    <form name="frm" action="AddInternetBanking.jsp" method="post" class="form-horizontal form-label-left" novalidate>
                        <div class="item form-group">
                            <input type="text" name="bankac" id="mobile" class="form-control col-md-7 col-xs-12"  placeholder="Bank Account Number" required="required"/>
                        </div>
                        <div class="item form-group">
